...
const routes = ["/property-1", "/property-3"];
const images = [
  "https://mysecrethomebali.com/wp-content/uploads/2024/08/download-2024-08-25T143245.358-720x921.png",
  "https://mysecrethomebali.com/wp-content/uploads/2024/08/download-53-1.png",
        ...
        <div className="w-full md:w-3/4 pr-6 mr-12">
          ...
          <div className="flex items-center text-1xl space-x-6  mb-10">
            ...
            <div className="flex items-center text-gray-900">
              <FontAwesomeIcon icon={faUserFriends} className="mr-2" />4 Guest
            </div>
            <div className="flex items-center text-gray-900">
          ...
          <div className="text-sm text-gray-700 leading-6 space-y-6">
            <div>
              <p className="mb-4">
                Welcome to Room 2, the perfect space for those looking for a
                comfortable and functional room with a touch of luxury.
              </p>
              <p className="mb-4">
                This room features a unique double floor mezzanine design,
                providing a separate private working area and a cozy relaxing
                area downstairs, bedroom above and close to the AC. The spacious
                wardrobe provides ample storage for all your belongings,
                ensuring a clutter-free stay
              </p>
            </div>
            <div>
              <h4 className="font-small mb-4 mt-4">The space</h4>
              <p className="mb-2">🏛Room 02 Nepal</p>
              <p className="mb-4">
                We Welcome you in this lovely loft, which is the ideal setting
                for anyone seeking a cozy, useful place with a hint of luxury.
                Take a step outside and you will find a delightful outdoor area
                where you can soak up the refreshing breeze and relax after a
                long day. Whether you want to catch up on some reading, enjoy a
                cup of coffee, or simply unwind and take in the beautiful
                surroundings, our outside area is the perfect place to do so.
              </p>

              <p className="mb-2"> ✔ Second Largest Room</p>
              <p className="mb-2">
                {" "}
                ✔ This room features a unique double floor mezzanine design
              </p>
              <p className="mb-2"> ✔ Dedicated Space for office Work</p>
              <p className="mb-2"> ✔ 1 Queen Bed</p>
              <p className="mb-2"> ✔ Private Bathroom with Shower</p>
              <p className="mb-2"> ✔ Room 2 has a Projector (on demand)</p>
              ...
              <p className="mb-2">
                Ideal for long stays, this room also includes a walk-in closet
                and dedicated working room, allowing you to maintain your
                productivity and stay on top of your work while enjoying your
                stay with us.
              </p>
            </div>
            <hr className="my-6" />
          ...
          <div className="bg-white shadow-lg p-4 mb-7 mt-12 border-2 border-gray-100">
            ...
            {isPriceOpen && (
              <p className="text-sm text-gray-700">Price per night: $117</p>
            )}
          </div>
          {/* Address Card */}
          <div className="bg-white shadow-lg p-4 mb-7 mt-12 border-2 border-gray-100">
