...
const Property1 = () => {
  ...
  const getCurrentImageIndex = (propertyId, totalImages) => {
    const currentIdx = currentImages[propertyId] || 0;
    return currentIdx % totalImages;
  };
  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-between mt-10 px-8 md:px-20">
        ...
        <div className="w-full md:w-3/4 pr-6 mr-12">
          ...
          <div className="text-sm text-gray-700 leading-6 space-y-6">
            {propertyData.description?.sections
      ...
      {propertyData?.similarListings &&
        propertyData.similarListings.length > 0 && (
          <div className="mt-16">
            ...
            <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-24">
              {propertyData.similarListings.map((property) => {
                  ...
                  >
                    <div className="relative">
                      <img
                        ...
                        onError={(e) => {
                          console.error(
                            `Failed to load image: ${property.images[imageIndex]}`
                          );
                          e.target.src =
